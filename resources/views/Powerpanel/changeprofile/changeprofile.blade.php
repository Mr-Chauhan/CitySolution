    ...
    <div class="container-fluid">
      ...
      <body class="bg-gradient-primary">
        ...
        @include('powerpanel.flash_message') 
				...
				<input type="hidden" name='hidPass' value="<?php echo $user->password;?>">
				
				{!! Form::model($user,['method'=>'PATCH','route'=>['profile.update',$user->id]])!!}
				<?php //echo $user->password;exit;?>
                ...
                <div class="form-group">
                  {!!Form::label('varPersonalEmail','Email:')!!}
                ...
                <div class="form-group">
                  ...
                  {!!Form::select('fkRoleId',[''=>'Choose Options']+ $roles,null,['class'=>'form-control form-control-user'])!!}
                </div>
             
                <div class="form-group">
                  {!!Form::label('is_active','Status:')!!}
                  {!!Form::select('is_active',array(1=>'Active',0=>'Not Active'),null,['class'=>'form-control form-control-user'])!!}
                </div>
                <div class="form-group">
